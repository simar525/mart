...
class BuyerTaxController extends Controller
{
    public function index()
    {
        ...
        return view('admin.settings.buyer-taxes.index', [
    ...
    {
        return view('admin.settings.buyer-taxes.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.settings.buyer-taxes.index');
    }

    public function edit(BuyerTax $buyerTax)
    {
        return view('admin.settings.buyer-taxes.edit', [
            'buyerTax' => $buyerTax,
        ]);
    }
