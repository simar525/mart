...
class PaymentGatewayController extends Controller
{
    public function index()
    {
        ...
        return view('admin.settings.payment-gateways.index', ['paymentGateways' => $paymentGateways]);
    }
    ...
    {
        return view('admin.settings.payment-gateways.edit', ['paymentGateway' => $paymentGateway]);
    }
