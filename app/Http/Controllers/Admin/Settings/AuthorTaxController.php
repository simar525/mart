...
class AuthorTaxController extends Controller
{
    public function index()
    {
        ...
        return view('admin.settings.author-taxes.index', [
    ...
    {
        return view('admin.settings.author-taxes.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.settings.author-taxes.index');
    }

    public function edit(AuthorTax $authorTax)
    {
        return view('admin.settings.author-taxes.edit', [
            'authorTax' => $authorTax,
        ]);
    }
