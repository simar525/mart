...
@section('back', route('admin.settings.withdrawal-methods.index'))
@section('content')
    <div class="card">
        <div class="card-body p-4">
            <form id="vironeer-submited-form" action="{{ route('admin.settings.withdrawal-methods.store') }}" method="POST">
                @csrf
