                ...
                <div class="card-v border p-4 mb-4">
                    ...
                    <div class="row g-3">
                        @foreach ($paymentGateways as $paymentGateway)
                            <div
                                class="{{ $paymentGateway->isAccountBalance() ? 'col-12' : 'col-12 col-sm-6 col-lg-4' }}">
                ...
                <div class="mb-3">
                    @foreach ($trx->trxItems as $trxItem)
                        @php
                            $item = $trxItem->item;
                        @endphp
                        <div class="row g-3 align-items-center mb-2 py-3">
                            <div class="col-auto">
                                <a href="{{ $item->getLink() }}">
                                ...
                                <div class="row g-3 row-cols-auto">
                                    ...
                                    <div class="col">
                                        <div class="small">
                                            ...
                                            <span class="text-muted">{{ getAmount($trxItem->price, 0) }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-auto text-center">
                                <h6 class="mb-0 ms-auto">{{ getAmount($trxItem->total, 0) }}</h6>
                            </div>
                        </div>
                    @endforeach
                </div>
