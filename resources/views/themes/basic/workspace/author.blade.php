    ...
    <div class="card-v">
        ...
        <div class="text-center">
            <form action="{{ route('workspace.become-an-author') }}" method="POST">
                @csrf
                @if (@$settings->links->author_terms)
                    <div class="mb-3">
                        <div class="form-check d-flex justify-content-center">
                            ...
                            <label class="form-check-label" for="author-terms">
                                ...
                                <a href="{{ @$settings->links->author_terms }}">
                ...
                @endif
                @if (@$settings->referral->status && @$settings->links->referral_terms)
                    <div class="mb-3">
                        <div class="form-check d-flex justify-content-center">
                            ...
                            <label class="form-check-label" for="referral-terms">
                                {{ translate('I read and I agree with the') }}
                                <a href="{{ @$settings->links->referral_terms }}">
